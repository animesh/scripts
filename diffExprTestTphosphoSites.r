#Rscript.exe diffExprTestTphosphoSites.r L:/promec/TIMSTOF/LARS/2024/241118_Deo/phos/combined/txt/ Bio 1
...
for(i in 1:3){
  ...
  #C2####
  ttC2=testT(log2LFQ,"C2","C1",cvThr)
  #C4####
  ttC4=testT(log2LFQ,"C4","C1",cvThr)
  #C6####
  ttC6=testT(log2LFQ,"C6","C1",cvThr)
  #close####
  dev.off()
}
