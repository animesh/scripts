...
#comet.nextprot.elite.params
'''
# comet_version 2020.01 rev. 2
# Comet MS/MS search engine parameters file.
# Everything following the '#' symbol is treated as a comment.

database_name = L:\promec\FastaDB\nextprot_all.peff
decoy_search = 1                       # 0=no (default), 1=concatenated search, 2=separate search
peff_format = 1                        # 0=no (normal fasta, default), 1=PEFF PSI-MOD, 2=PEFF Unimod
peff_obo =  L:\promec\FastaDB\PSI-MOD.obo.txt                           # path to PSI Mod or Unimod OBO file
...
variable_mod02 = 42.010565 n 0 3 -1 0 0
variable_mod03 = 0.9840 NQ 0 3 -1 0 0 0.0
...
output_suffix =  _nextprot                      # add a suffix to output base names i.e. suffix "-C" generates base-C.pep.xml from base.mzXML input
