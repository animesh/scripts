#C:\Users\animeshs>R-4.4.0\bin\Rscript.exe "drive\My Drive\scripts\uniprotIDmap.r"  L:\promec\Animesh\Motif\uniprot_sprot.motif.found.txt L:\promec\Animesh\Motif\GO.tsv
#setup####
#download.file("https://rest.uniprot.org/uniprotkb/stream?download=true&fields=accession%2Creviewed%2Cid%2Cprotein_name%2Cgene_names%2Corganism_name%2Clength%2Cgo_p%2Cgo_c%2Cgo_f%2Cxref_ensembl_full&format=tsv&query=%28%28database%3AGO%29+AND+%28reviewed%3Atrue%29%29","L:/promec/Animesh/Motif/GO.tsv")
...
#annotationGO <- "L:/promec/Animesh/Motif/GO.tsv"
print(args)
#data####
...
write.csv(dataMap,paste0(inpF,"GOIDs.csv"))
...
write.csv(dataGOBP,paste0(inpF,"GOID.count.csv"))
