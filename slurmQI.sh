#git checkout def35f5515d2a6bb0c49b9952a4c9a844a7bb73a slurmQI.sh scratch.slurm
#dos2unix scratch.slurm slurmQI.sh
#bash slurmQI.sh $PWD/TK/star.1691068198.results $PWD/CHM13v2-T2T/GCF_009914755.1_T2T-CHM13v2.0_genomic.gtf
DATADIR=$1
GFF=$2
RUNCMD=qualimap
