...
sum(wikiWP2369)
(choose(16,13)*choose(3663,1293))/(choose(4972,1306))
fisher.test(wikiWP2369, alternative = "less")
fisher.test(wikiWP2369)
fisher.test(wikiWP2369, conf.level = 0.95)$conf.int
fisher.test(wikiWP2369, conf.level = 0.99)$conf.int
```
