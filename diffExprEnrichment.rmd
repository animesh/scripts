...
wikiP <- matrix(c(2,1,5000,5000), nrow = 2,dimnames =list(wikiP=c("full", "selected"),pWiki=c("selected", "other")))
fisher.test(wikiP)
wikiP <- matrix(c(200,100,5000,5000), nrow = 2,dimnames =list(wikiP=c("full", "selected"),pWiki=c("selected", "other")))
fisher.test(wikiP)
wikiP <- matrix(c(20,10,5000,5000), nrow = 2,dimnames =list(wikiP=c("full", "selected"),pWiki=c("selected", "other")))
fisher.test(wikiP)
