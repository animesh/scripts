...
```{r data, echo = FALSE}
inpF<-paste0(inpD,"proteinGroups.txtLpromecAnimeshKristianM1_Mono_MOtestsM.csv")
...
summary(log2LFQ)
hist(log2LFQ)
writexl::write_xlsx(as.data.frame(cbind(data$Gene,log2LFQ,data$ChkG,data$GN,data$RowGeneUniProtScorePeps)),paste0(inpF,"gene.xlsx"))
```
