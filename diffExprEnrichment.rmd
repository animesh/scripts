...
```{r loadPlotKM}
load(paste0(inpD,"MMRFclin.rds"))
load(paste0(inpD,"MMRFdataPrepro.rds"))
TCGAbiolinks::TCGAanalyze_SurvivalKM(MMRFclin,MMRFdataPrepro,Genelist = c("ENSG00000128694"),Survresult = T,ThreshTop=0.76,ThreshDown=0.33) #		Q9NPF4	OSGEP GCPL1
TCGAbiolinks::TCGAanalyze_SurvivalKM(MMRFclin,MMRFdataPrepro,Genelist = c("ENSG00000145996"),Survresult = T,ThreshTop=0.76,ThreshDown=0.33) #	Q5VV42	CDKAL1
```
