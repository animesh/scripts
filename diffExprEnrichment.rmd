...
wikiWP411 <- matrix(c(58,1941-71,3031-58,71), nrow = 2,dimnames =list(wikiP=c("selected", "full"),pWiki=c("selected", "other")))
wikiWP411
sum(wikiWP411)
fisher.test(wikiWP411, alternative = "less")
fisher.test(wikiWP411)
fisher.test(wikiWP411, conf.level = 0.95)$conf.int
fisher.test(wikiWP411, conf.level = 0.99)$conf.int
```
