...
summary(log2LFQ)
#install.packages("writexl")#, repos="http://cran.r-project.org", lib="C:/Users/animeshs/GD/R_libs")
library("writexl",lib="C:/Users/animeshs/GD/R_libs")
write_xlsx(as.data.frame(cbind(data$Uniprot,log2LFQ)),paste0(inpF,"uniprot.xlsx"))
```
