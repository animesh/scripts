...
colnames(hdaC)<-sub(selection,"",colnames(hdaC))
row.names(hdaC)<-colnames(hdaC)
...
pheatmap::pheatmap(hdaC,fontsize_row=5,fontsize_col=5,annotation_row=groupsT,annotation_col=groupsT)
...
pheatmap::pheatmap(hdaC,fontsize_row=6,annotation_row=groupsR)#[["Type"]])annotation_row=groupsR,
ComplexHeatmap::Heatmap(hdaC)
```
