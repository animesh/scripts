```{r data}
inpF<-"L:/promec/Qexactive/LARS/2019/november/Kristian Starheim/combined/txt/proteinGroups.txt"
data<-read.table(inpF,header=T,sep="\t",row.names = 1)
summary(data)
```

```{r label}
inpL<-"L:/promec/Qexactive/LARS/2019/november/Kristian Starheim/combined/txt/Groups_kristian.txt"
