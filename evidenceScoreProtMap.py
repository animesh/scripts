...
#pathFiles = Path("L:/promec/TIMSTOF/LARS/2021/Oktober/211031FinnFinal")
...
dfP=df.pivot_table(index='ID', columns='Raw file', values='Score', aggfunc='sum')
dfP.to_csv(pathFiles/(fileName+'.combinedScore.csv'))#,sep="\")#,rownames=FALSE)
