...
if ($#ARGV != 3)
{
    print "Useage: $0  old_id_file  new_id_file  input_file  output_file\n";
    print "   translates the read indices in  input_file, based on  old_id_file,\n";
