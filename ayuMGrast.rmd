...
```{r, file_paths}
atlas_wd_folder = "C:/Users/animeshs/Desktop/R/"
...
ggplot(grouped_data, aes_string(x = "Sample", y = "summarized_rel_ab", fill = level)) +
  ...
  scale_fill_manual(values = c("#771155", "#AA4488", "#CC99BB", "#114477", "#4477AA", "#77AADD", "#117777", "#44AAAA", "#77CCCC", "#117744", "#44AA77", "#88CCAA", "#777711", "#AAAA44", "#DDDD77", "#774411", "#AA7744", "#DDAA77", "#771122", "#AA4455", "#DD7788", "#DDDD77", "#774411", "#AA7744", "#DDAA77", "#771122", "#AA4455", "#DD7788"))
...
```{r load_metadata}
# load metadata
metadata <- read_tsv('samples.tsv',show_col_types = FALSE) %>% column_to_rownames("Name")
...
d.eff<-aldex.kw(x)
d.tt <- d.eff
d.eff <- aldex.effect(x, CI=T, verbose=FALSE)
