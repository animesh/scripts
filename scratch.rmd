...
expBATCH(D=Breast,batchCL=batchBreast,Conf=NA,mindim=2,maxdim=9,method="ppcca",SDselect=3)
...
#names(dtmpB)<-names(dataNormImpCom)
...
expBATCH(D=dtmpB,batchCL=factorB,Conf=NA,mindim=2,maxdim=6,method="ppcca",SDselect=2)
dim(Breast)
dim(batchBreast)
dim((dtmpB))
rownames(dtmpB)
...
colnames(dtmpB)
colnames(Breast)
#expBATCH(D=dtmp,batchCL=dtmpB,Conf=NA,mindim=2,maxdim=9,method="ppcca",SDselect=2)
#dtmp[is.na(dtmp)]=0
```
