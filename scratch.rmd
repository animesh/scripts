...
library(quantreg)
data<-log2(data)
rqfit <- rq(Intensity ~ LFQ.intensity.ung_phos_ub, data = data)
summary(rqfit)
plot(Intensity ~ LFQ.intensity.ung_phos_ub, data = data, pch = 16, main = "Intensity ~ LFQ.intensity.ung_phos_ub")
abline(lm(Intensity ~ LFQ.intensity.ung_phos_ub, data = data), col = "red", lty = 2)
abline(rq(Intensity ~ LFQ.intensity.ung_phos_ub, data = data), col = "blue", lty = 2)
