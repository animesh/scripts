...
school8_dat <- list(J = 8, 
                    y = c(28,  8, -3,  7, -1,  1, 18, 12),
                    sigma = c(15, 10, 16, 11,  9, 11, 10, 18))
fit<-stan(file='school8.stan',data=school8_dat)
print(fit)
plot(fit)
...
rats_fit = stan('https://raw.githubusercontent.com/stan-dev/example-models/master/bugs_examples/vol1/rats/rats.stan',y)
plot(rats_fit)
pairs(fit, pars = c("mu", "tau", "lp__"))
x = c(8, 15, 22, 29, 36)
xbar <- mean(x)
