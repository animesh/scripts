...
p = ggplot2::ggplot(data, ggplot2::aes(data$hI,data$pI)) +   ggplot2::geom_jitter(position = ggplot2::position_jitter(width = 0.3), ggplot2::aes(color = factor(data$Group)), size = 2.5, alpha = 1) + ggplot2::facet_wrap(~File)
print(p)
