...
inpF<-"L:/promec/Animesh/HeLa/ayu/new/combined biological function.txt"
...
pheatmap(y$data,scale="row",annotation_col = label, clustering_distance_rows = "correlation",clustering_distance_cols = "correlation")
```
...
yy<-t(yy)
write.csv(yy,"L:/promec/Animesh/HeLa/ayu/new/combined biological function.csv")
