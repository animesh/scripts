...
summary(warnings())
hist(pValNA)
S_dataSellog2grpWSRT<-cbind(uniprot,dataSellog2grpWSRT,pValNA,data[,7],rownames(S_dataSellog2grpWSRT))
...
#exceltest 
#=IF(AND(SIGN(B2)=SIGN(C2),SIGN(D2)=SIGN(C2)),1,0)
#install.packages("readxl")
#library(readxl)
...
plot(as.matrix(resMatlab[,7]),pValNA)
```
