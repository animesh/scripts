...
('dir' =  '>C:\Program Files\fnordctl\root\enote1.12\html\notebook','title' = ">proj",)
};

# Example of how to specify additional notebooks
$main::notebook{'data'} = {(
  'dir'=> 'C:\Program Files\fnordctl\root\enote1.12\html\instrument\', 'title'=> "Raw Instrument",)
};
...
$main::subscription = 'C:\Program Files\fnordctl\root\enote1.12\html\subscriptions.ens';
...
$main::libdir = C:\Program Files\fnordctl\root\cgi-bin';
