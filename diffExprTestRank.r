#for %i in ("L:\promec\TIMSTOF\LARS\2022\july\Elise\combined\txt\corrected_order_TSH_update*.txt") do ("..\R\bin\Rscript.exe" "diffExprTestRank.r" "L:\promec\TIMSTOF\LARS\2022\july\Elise\combined\txt\proteinGroups.txt" "%i" "Intensity." "cancerVlymphocytes" "Cell" "Remove")
#setup
