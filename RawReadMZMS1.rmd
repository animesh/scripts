...
par(mfrow=c(1,2))
#data
inpD<-"L:/promec/Elite/LARS/2021/april/olej/second run SAX 2/"
```
...
## for %i in ("L:\promec\Elite\LARS\2021\april\olej\second run SAX 2\*.raw") do ("L:\promec\Elite\LARS\2021\april\olej\second run SAX 2\RawRead\RawRead-blazor\RawRead.exe" "%i")
