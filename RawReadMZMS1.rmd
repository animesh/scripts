...
```{r data}
#for %i in (L:\promec\Elite\LARS\2021\april\olej\*.raw) do (RawRead.exe %i)
inpD<-"L:/promec/Elite/LARS/2021/april/olej/"
inpF<-"210408_EL20_c18_urt3.raw.intensityThreshold1000.errTolDecimalPlace3.MZ1R.csv"
...
```{r data}
inpF="210408_EL250_SAX_urt3.raw.intensityThreshold1000.errTolDecimalPlace3.MZ1R.csv"
data<-read.csv(paste0(inpD,inpF))
hist(as.numeric(data[,2]))
...
```{r data}
inpF="210408_EL250_SAX_urt3_210409134630.raw.intensityThreshold1000.errTolDecimalPlace3.MZ1R.csv"
data<-read.csv(paste0(inpD,inpF))
hist(as.numeric(data[,2]))
hist(log2(as.numeric(data[,4])))
assign(inpF,data)
...
```{r data}
inpF="210408_EL50_c18_urt3.raw.intensityThreshold1000.errTolDecimalPlace3.MZ1R.csv"
data<-read.csv(paste0(inpD,inpF))
hist(as.numeric(data[,2]))
hist(log2(as.numeric(data[,4])))
assign(inpF,data)
...
```{r data}
inpF="210408_FT_c18_urt3.raw.intensityThreshold1000.errTolDecimalPlace3.MZ1R.csv"
data<-read.csv(paste0(inpD,inpF))
hist(as.numeric(data[,2]))
hist(log2(as.numeric(data[,4])))
assign(inpF,data)
...
```{r data}
inpF="210408_FT_SAX_urt3.raw.intensityThreshold1000.errTolDecimalPlace3.MZ1R.csv"
data<-read.csv(paste0(inpD,inpF))
hist(as.numeric(data[,2]))
hist(log2(as.numeric(data[,4])))
assign(inpF,data)
...
```{r data}
inpF="210408_FT_SAX_urt3_210409113040.raw.intensityThreshold1000.errTolDecimalPlace3.MZ1R.csv"
data<-read.csv(paste0(inpD,inpF))
hist(as.numeric(data[,2]))
hist(log2(as.numeric(data[,4])))
assign(inpF,data)
...
```{r merge}
data<-merge(`210408_EL20_c18_urt3.raw.intensityThreshold1000.errTolDecimalPlace3.MZ1R.csv`,`210408_EL250_SAX_urt3.raw.intensityThreshold1000.errTolDecimalPlace3.MZ1R.csv`,by="MZ1",all=T)
colnames(data)<-gsub(".x","EL20_c18_urt3",colnames(data))
colnames(data)<-gsub(".y","EL250_SAX_urt3",colnames(data))
data<-merge(data,`210408_EL250_SAX_urt3_210409134630.raw.intensityThreshold1000.errTolDecimalPlace3.MZ1R.csv`, by="MZ1",all=T)
data<-merge(data,`210408_EL50_c18_urt3.raw.intensityThreshold1000.errTolDecimalPlace3.MZ1R.csv`, by="MZ1",all=T)
colnames(data)<-gsub(".x","EL250_SAX_urt3_210409134630",colnames(data))
colnames(data)<-gsub(".y","EL50_c18_urt3",colnames(data))
data<-merge(data,`210408_FT_c18_urt3.raw.intensityThreshold1000.errTolDecimalPlace3.MZ1R.csv`, by="MZ1",all=T)
data<-merge(data,`210408_FT_SAX_urt3.raw.intensityThreshold1000.errTolDecimalPlace3.MZ1R.csv`, by="MZ1",all=T)
colnames(data)<-gsub(".x","FT_c18_urt3",colnames(data))
colnames(data)<-gsub(".y","FT_SAX_urt3",colnames(data))
data<-merge(data,`210408_FT_SAX_urt3_210409113040.raw.intensityThreshold1000.errTolDecimalPlace3.MZ1R.csv`, by="MZ1",all=T)
