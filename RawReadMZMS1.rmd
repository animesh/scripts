...
inpD<-"L:/promec/Elite/LARS/2021/april/olej/second run SAX/"
inpF<-"210408_EL250_SAX_urt3_210416121234.raw.intensityThreshold1000.errTolDecimalPlace3.MZ1R.csv"
...
```{r data2}
inpF="210408_EL250_SAX_urt3_210416173339.raw.intensityThreshold1000.errTolDecimalPlace3.MZ1R.csv"
data<-read.csv(paste0(inpD,inpF))
hist(as.numeric(data[,2]))
hist(log2(as.numeric(data[,4])))
assign(inpF,data)
...
```{r data3}
inpF="210408_FT_SAX_urt3_210416095759.raw.intensityThreshold1000.errTolDecimalPlace3.MZ1R.csv"
data<-read.csv(paste0(inpD,inpF))
hist(as.numeric(data[,2]))
hist(log2(as.numeric(data[,4])))
assign(inpF,data)
...
```{r data4}
inpF="210408_FT_SAX_urt3_210416151908.raw.intensityThreshold1000.errTolDecimalPlace3.MZ1R.csv"
data<-read.csv(paste0(inpD,inpF))
hist(as.numeric(data[,2]))
hist(log2(as.numeric(data[,4])))
assign(inpF,data)
...
```{r merge}
data<-merge(data,`210408_FT_SAX_urt3_210416095759.raw.intensityThreshold1000.errTolDecimalPlace3.MZ1R.csv`,by="MZ1",all=T)
colnames(data)<-gsub(".x","FT_SAX_urt3_210416151908",colnames(data))
colnames(data)<-gsub(".y","FT_SAX_urt3_210416095759",colnames(data))
data<-merge(data,`210408_EL250_SAX_urt3_210416173339.raw.intensityThreshold1000.errTolDecimalPlace3.MZ1R.csv`, by="MZ1",all=T)
data<-merge(data,`210408_EL250_SAX_urt3_210416121234.raw.intensityThreshold1000.errTolDecimalPlace3.MZ1R.csv`, by="MZ1",all=T)
colnames(data)<-gsub(".x","EL250_SAX_urt3_210416173339",colnames(data))
colnames(data)<-gsub(".y","EL250_SAX_urt3_210416121234",colnames(data))
hist(data$MZ1)
hist(log2(data$MZ1))
...
```{r plot}
hda<-cbind(data$log2sumIntensiFT_SAX_urt3_210416095759FT_SAX_urt3_210416151908,data$log2sumIntensiFT_SAX_urt3_210416095759FT_SAX_urt3_210416095759,data$log2sumIntensiEL250_SAX_urt3_210416121234EL250_SAX_urt3_210416173339,data$log2sumIntensiEL250_SAX_urt3_210416121234EL250_SAX_urt3_210416121234)
hist(hda)
hda[is.na(hda)]<-0
limma::vennDiagram(hda>0)
log2LFQimpCorr<-cor(hda,use="pairwise.complete.obs",method="pearson")
colnames(log2LFQimpCorr)<-colnames(hda)
...
```{r mergeData}
inpF<-"210408_FT_SAX_urt3_210416151908.raw.intensityThreshold1000.errTolDecimalPlace3.MZ1R.csv.combined.csv"
data<-read.csv(paste0(inpD,inpF))
