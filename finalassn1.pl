#!/usr/bin/perl
$linenew="";
#print "enter the contig file name : \n";
#$liwe=<>;
#chomp $liwe;
open (FH,"AC109365.fas.1") || die "cant open file : $!";
while ($line1=<FH>){
chomp $line1;
...
#print "$linenew\n";
$count=0;
#print "enter the out file name : \n";
#$liwen=<>;
#chomp $liwen;
open (F, "AC109365.fas.1.glimmerR") || die "cant open file : $!";
