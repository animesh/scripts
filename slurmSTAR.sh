#git checkout 069e21a60b8255c8e0c493413565ace1b92e84e3 scratch.slurm
#dos2unix scratch.slurm
#bash slurmSTAR.sh $PWD/TK hg38v110star/hg38_index_len150
DATADIR=$1
MAPFILE=$2
RUNCMD=star
...
#cat  /cluster/home/ash022/scripts/TK/star.1690114446.results/*slurm |grep "readFilesIn"
