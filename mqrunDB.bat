...
>> "%SQL%" echo "Majority protein IDs",
>> "%SQL%" echo "Peptide counts (all)",
>> "%SQL%" echo "Peptide counts (razor+unique)",
>> "%SQL%" echo "Peptide counts (unique)",
>> "%SQL%" echo "Protein names",
>> "%SQL%" echo "Gene names",
>> "%SQL%" echo "Fasta headers",
>> "%SQL%" echo "Number of proteins",
>> "%SQL%" echo "Peptides",
>> "%SQL%" echo "Razor + unique peptides",
>> "%SQL%" echo "Unique peptides",
>> "%SQL%" echo "Sequence coverage [%%]",
>> "%SQL%" echo "Unique + razor sequence coverage [%%]",
>> "%SQL%" echo "Unique sequence coverage [%%]",
>> "%SQL%" echo "Mol. weight [kDa]",
>> "%SQL%" echo "Sequence length",
>> "%SQL%" echo "Sequence lengths",
>> "%SQL%" echo "Q-value",
>> "%SQL%" echo "Score",
>> "%SQL%" echo "Intensity",
...
>> "%SQL%" echo "iBAQ",
>> "%SQL%" echo "Top3",
>> "%SQL%" echo "MS/MS count",
>> "%SQL%" echo "Peptide sequences",
>> "%SQL%" echo "Only identified by site",
>> "%SQL%" echo "Reverse",
>> "%SQL%" echo "Potential contaminant",
>> "%SQL%" echo "id",
>> "%SQL%" echo "Peptide IDs",
>> "%SQL%" echo "Peptide is razor",
>> "%SQL%" echo "Mod. peptide IDs",
>> "%SQL%" echo "Evidence IDs",
>> "%SQL%" echo "MS/MS IDs",
>> "%SQL%" echo "Best MS/MS",
>> "%SQL%" echo "Deamidation (NQ) site IDs",
>> "%SQL%" echo "Oxidation (M) site IDs",
>> "%SQL%" echo "Deamidation (NQ) site positions",
>> "%SQL%" echo "Oxidation (M) site positions",
>> "%SQL%" echo "Taxonomy IDs",
>> "%SQL%" echo "Taxonomy names",
>> "%SQL%" echo ingested_at) SELECT '%RUN_NAME%',
>> "%SQL%" echo TRY_CAST("Protein IDs" AS VARCHAR),
>> "%SQL%" echo TRY_CAST("Majority protein IDs" AS VARCHAR),
>> "%SQL%" echo TRY_CAST("Peptide counts (all)" AS VARCHAR),
>> "%SQL%" echo TRY_CAST("Peptide counts (razor+unique)" AS VARCHAR),
>> "%SQL%" echo TRY_CAST("Peptide counts (unique)" AS VARCHAR),
>> "%SQL%" echo TRY_CAST("Protein names" AS VARCHAR),
>> "%SQL%" echo TRY_CAST("Gene names" AS VARCHAR),
>> "%SQL%" echo TRY_CAST("Fasta headers" AS VARCHAR),
>> "%SQL%" echo TRY_CAST("Number of proteins" AS INTEGER),
...
>> "%SQL%" echo TRY_CAST("Unique + razor sequence coverage [%%]" AS DOUBLE),
>> "%SQL%" echo TRY_CAST("Unique sequence coverage [%%]" AS DOUBLE),
>> "%SQL%" echo TRY_CAST("Mol. weight [kDa]" AS DOUBLE),
>> "%SQL%" echo TRY_CAST("Sequence length" AS INTEGER),
>> "%SQL%" echo TRY_CAST("Sequence lengths" AS VARCHAR),
...
>> "%SQL%" echo TRY_CAST("MS/MS count" AS INTEGER),
...
>> "%SQL%" echo TRY_CAST("Peptide IDs" AS VARCHAR),
>> "%SQL%" echo TRY_CAST("Peptide is razor" AS VARCHAR),
>> "%SQL%" echo TRY_CAST("Mod. peptide IDs" AS VARCHAR),
>> "%SQL%" echo TRY_CAST("Evidence IDs" AS VARCHAR),
>> "%SQL%" echo TRY_CAST("MS/MS IDs" AS VARCHAR),
>> "%SQL%" echo TRY_CAST("Best MS/MS" AS INTEGER),
>> "%SQL%" echo TRY_CAST("Deamidation (NQ) site IDs" AS VARCHAR),
>> "%SQL%" echo TRY_CAST("Oxidation (M) site IDs" AS VARCHAR),
>> "%SQL%" echo TRY_CAST("Deamidation (NQ) site positions" AS VARCHAR),
>> "%SQL%" echo TRY_CAST("Oxidation (M) site positions" AS VARCHAR),
>> "%SQL%" echo TRY_CAST("Taxonomy IDs" AS VARCHAR),
>> "%SQL%" echo TRY_CAST("Taxonomy names" AS VARCHAR),
