...
hist(pData$ENSG00000196449)
qVal=quantile(pData$ENSG00000196449,probs = seq(0, 1, 0.01))#qVal[67]#qVal[34]
max(pData$ENSG00000196449)#qVal[101]
min(pData$ENSG00000196449)#qVal[1]
