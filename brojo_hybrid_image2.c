...
double *iv;
char 	*outfile="image219_21_out.pgm";
...
void main()
{
	...
	strcpy(testingfile,"full219_test_norm.txt");
	...
	FILE *imageindex;
	imageindex=fopen("imageflag_219.txt","r");
	...
	strcpy(testingfile,"full219_2_test_norm.txt");
	fr = fopen(testingfile,"r");

	/**********************READ THE IMAGE INDEX FILE*********************************/

	
	imageindex=fopen("imageflag_219_2.txt","r");/****CHANGE IMAGE FLAG**********/
...
/******************************************************************************************************************************/	
	...
	case 3: 
		...
		/*********DYNAMIC MEMORY ALLOCATION FOR THE WEIGHT ARRAY*********/
   		...
   		f1 = fopen("/user1/home/brojo/matrics_59113/wih4","r");
		if(f1==NULL)
			printf("severe ERROR");
		fscanf(f1,"%d %d %lf",&inpNode,&hidNode,&n);
		...
		f1 = fopen("/user1/home/brojo/matrics_59113/who4","r");
