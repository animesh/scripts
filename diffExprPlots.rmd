...
ctr2<-apply(hda,1,function(x) if(sum(is.na(x[c(1:5)]))==0){median(x[c(1:5)],na.rm=T)} else{0})
sum(ctr2>0)
ctr2<-apply(hda,1,function(x) if(sum(is.na(x[c(1:5)]))<5){median(x[c(1:5)],na.rm=T)} else{0})
sum(ctr2>0)
