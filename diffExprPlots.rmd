...
write_xlsx(as.data.frame(cbind(fasta,protein,gene,unipro,hda,hdapim,hdaM)),inpW)
write.table(as.data.frame(cbind(fasta,protein,gene,unipro,hda,hdapim,hdaM)),paste0(inpW,".txt"),sep="\t",quote=T,row.names=F)
library("limma")
vennDiagram(hdaM>0)
