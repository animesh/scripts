...
```{r input}
inputPanel(shiny::selectInput("chart_type", label = "Chart Type", choices = c("Level", "Aggregated")))
```

```{r output}
#https://github.com/animesh/free_r_tips/blob/master/024_shiny_in_rmarkdown/024_shiny_in_rmarkdown.Rmd
...
```{r vennDiagram}
limma::vennDiagram(dataHighNormLog2[,1:5])
