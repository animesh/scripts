...
data_selr<-rbind.data.frame(dataSelApoptosis,dataSelMAPK,dataSelSTAT,dataSelAMPK,dataSel_PI3KAKTmTOR)
#data_selr<-dataSel
...
svgPHC<-pheatmap(data_selr,scale="row",clustering_distance_rows = "correlation",clustering_distance_cols = "correlation",fontsize_row=6,cluster_cols=FALSE,label_row = pathwayN,cluster_rows=FALSE)#,annotation_col = label,show_rownames=F)
library(ggplot2)
