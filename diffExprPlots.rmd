...
rownames(data)<-paste0(data$T..T..Uniprot,data$T..T..Line)
summary(data)
hdr="log2diff"
```
...
svgPHC<-pheatmap(data_selr,scale="row",clustering_distance_rows = "correlation",clustering_distance_cols = "correlation",fontsize_row=6,cluster_cols=FALSE)#,annotation_col = label,show_rownames=F)
#library(ggplot2)
