...
inpF<-paste0(inpD,"proteinGroupsLog2diffs.xlsx WSRTpvalGroups.txt")
...
hist(rowSums(as.matrix(dataS[,c(13,14,15,16)])))
vennDiagram(dataS[,c(13,14,15,16)]<selThr)
```
...
wikiPF<-paste0(inpD,"wikipathways-20200310-gmt-Homo_sapiens.gmt")
...
vennDiagram(dataSel[,c(15,16,17,18)]<selThr,main="STAT",counts.col = "red")
...
cn<-strsplit(colnames(dataSel), "_")
colnames(dataSel)<-paste(sapply(cn, "[", 2),sapply(cn, "[", 4))
vennDiagram(dataSel[,c(15,16,17,18)]<selThr,main="MAPK",counts.col = "red")
...
cn<-strsplit(colnames(dataSel), "_")
colnames(dataSel)<-paste(sapply(cn, "[", 2),sapply(cn, "[", 4))
vennDiagram(dataSel[,c(15,16,17,18)]<selThr,main="AMPK",counts.col = "red")
...
cn<-strsplit(colnames(dataSel), "_")
colnames(dataSel)<-paste(sapply(cn, "[", 2),sapply(cn, "[", 4))
vennDiagram(dataSel[,c(15,16,17,18)]<selThr,main="PI3K/AKT/mTOR",counts.col = "red")
...
cn<-strsplit(colnames(dataSel), "_")
colnames(dataSel)<-paste(sapply(cn, "[", 2),sapply(cn, "[", 4))
vennDiagram(dataSel[,c(15,16,17,18)]<selThr,main="Apoptosis",counts.col = "red")
