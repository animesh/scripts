...
#bash slurmDIANN.sh /cluster/projects/nn9036k/scrbkup/250805_Kamila
...
#rsync -Parv TIMSTOF/LARS/2025/250805_Kamila/*Kam*.d 250805_Kamila/
#for i in $PWD/250805_Kamila/*.d ; do grep "TestFile.d" ; sed -i "s|TestFile\.d|$i|g" $i.slurm  ;done
DATADIR=$1
...
squeue -u ash022
#rsync -Parv 250805_Kamila/*.report.* /nird/projects/NS9036K/NORSTORE_OSL_DISK/NS9036K/promec/promec/TIMSTOF/LARS/2025/250805_Kamila/
