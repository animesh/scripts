```{r proteinGroups}
inpD <-"L:/promec/Qexactive/LARS/2020/mars/Heidi nano/combined/txt/"
...
ggsave(file=paste0(inpD,selection,cn,"ColCorClusterPlot.svg"),plot=svgPHC) 
```
...
ggsave(file=paste0(inpD,selection,cn,"GeneRowColClusterPlot.svg"),plot=svgPHC) 
```
