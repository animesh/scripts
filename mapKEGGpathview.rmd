```{r setup}
inpD <-"L:/OneDrive - NTNU/PROMEC01/IDH1/"
...
```{r data}
inpF1<-paste0(inpD,"proteinGroups.txtLFQ.intensity.16MUT CtrlWT Ctrl0.050.50.05BiotTestBH.csv")
data1<-read.csv(inpF1,row.names = 18)
inpF2<-paste0(inpD,"proteinGroups.txtLFQ.intensity.16MUTctrlWTctrl0.050.50.05grouptTestBH.csv")
data2<-read.csv(inpF2,row.names = 17)
#dataS<-as.matrix(data1[,c(17)],rownames=T)#as.matrix(data[,c(10:15)],rownames=T)
dataS<-as.matrix(data1[,c(10:15)],rownames=T)
