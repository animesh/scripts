...
diann.exe --f "F:\HeLaC\251216_200ngHelaQC_DDA_Slot1-54_1_12167.d" --f "F:\HeLaC\251216_200ngHelaQC_DIA_Slot1-54_1_12164.d" --lib "" --threads 12 --verbose 1 --out "F:\HeLaC\report.parquet" --qvalue 0.01 --matrices  --out-lib "F:\HeLaC\report-lib.parquet" --gen-spec-lib --reannotate --fasta camprotR_240512_cRAP_20190401_full_tags.fasta --cont-quant-exclude cRAP- --fasta "F:\UP000000625_83333.fasta" --fasta "F:\UP000005640_9606.fasta" --pre-search --pre-filter --met-excision --min-pep-len 7 --max-pep-len 30 --min-pr-mz 300 --max-pr-mz 1800 --min-pr-charge 1 --max-pr-charge 4 --min-fr-mz 200 --max-fr-mz 1800 --cut K*,R* --missed-cleavages 2 --unimod4 --var-mods 3 --var-mod UniMod:35,15.994915,M --var-mod UniMod:7,0.984016,NQ --var-mod UniMod:1,42.010565,*n --mass-acc 15 --mass-acc-ms1 15 --individual-mass-acc --individual-windows --peptidoforms --rt-profiling --use-quant --reanalyse
C:\
