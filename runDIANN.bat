...
::runDIANN.bat F:\promec\TIMSTOF\LARS\2026 32 --high-acc
...
set diannCmd=diann.exe!fileList!  --lib "F:\promec\FastaDB\uniprotkb_proteome_UP000001449_2026_01_09MC2V3dwfaults.predicted.speclib" --threads %NCPU% --verbose 1 --out "!outputDir!\report.parquet" --qvalue 0.01 --matrices --out-lib "!outputDir!\report-lib.parquet" --gen-spec-lib --reannotate --fasta "camprotR_240512_cRAP_20190401_full_tags.fasta" --cont-quant-exclude cRAP- --fasta "F:\promec\FastaDB\uniprotkb_proteome_UP000001449_2026_01_09.fasta" --min-fr-mz 200 --max-fr-mz 1800  --met-excision --min-pep-len 7 --max-pep-len 30 --min-pr-mz 300 --max-pr-mz 1800 --min-pr-charge 1 --max-pr-charge 4 --cut K*,R* --missed-cleavages 2 --unimod4 --var-mods 3 --var-mod UniMod:35,15.994915,M --var-mod UniMod:1,42.010565,*n --mass-acc 20.0 --mass-acc-ms1 20 --peptidoforms --reanalyse --rt-profiling

if not "%mode%"=="" set diannCmd=!diannCmd! %mode%

!diannCmd!
::diann.exe --lib "" --threads 32 --verbose 1 --out "F:\promec\FastaDB\uniprotkb_proteome_UP000001449_2026_01_09MC2V3defaults.parquet" --qvalue 0.01 --matrices  --out-lib "F:\promec\FastaDB\uniprotkb_proteome_UP000001449_2026_01_09MC2V3dwfaults.parquet" --gen-spec-lib --predictor --reannotate --fasta camprotR_240512_cRAP_20190401_full_tags.fasta --cont-quant-exclude cRAP- --fasta "F:\promec\FastaDB\uniprotkb_proteome_UP000001449_2026_01_09.fasta" --fasta-search --min-fr-mz 200 --max-fr-mz 1800 --met-excision --min-pep-len 7 --max-pep-len 30 --min-pr-mz 300 --max-pr-mz 1800 --min-pr-charge 1 --max-pr-charge 4 --cut K*,R* --missed-cleavages 2 --unimod4 --var-mods 3 --var-mod UniMod:35,15.994915,M --var-mod UniMod:1,42.010565,*n --mass-acc 20 --mass-acc-ms1 20 --peptidoforms --reanalyse --rt-profiling
