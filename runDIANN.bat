:: runDIANN.bat F:\promec\TIMSTOF\LARS\2025\250929_Rabina_DIA 4
:: runDIANN.bat F:\promec\TIMSTOF\LARS\2025\250902_Alessandro 10 --high-acc
:: runDIANN.bat F:\promec\TIMSTOF\LARS\2025\250902_Alessandro 12 --direct-quant
...
for /d %%i in (%dataDir%\*.d) do (
    ...
    set diannCmd=diann.exe --f "%%i" --lib "F:\promec\FastaDB\UP000005640_9606_unique_gene_MC2V3.predicted.predicted.speclib" --threads %NCPU% --verbose 1 --out "!outputDir!\report.parquet" --qvalue 0.01 --matrices --out-lib "!outputDir!\report-lib.parquet" --gen-spec-lib --reannotate --fasta "camprotR_240512_cRAP_20190401_full_tags.fasta" --cont-quant-exclude cRAP- --fasta "F:\promec\FastaDB\UP000005640_9606_unique_gene.fasta" --met-excision --cut K*,R* --missed-cleavages 2 --unimod4 --var-mods 3 --var-mod UniMod:35,15.994915,M --var-mod UniMod:1,42.010565,*n --mass-acc 50.0 --mass-acc-ms1 50 --peptidoforms --rt-profiling
