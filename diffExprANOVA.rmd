...
inpF<-"F:/OneDrive - NTNU/Desktop/Tobias/proteinGroups.txt"
...
svgPHC<-pheatmap::pheatmap(countTableDAuniGORNAdds,clustering_distance_rows = "euclidean",clustering_distance_cols = "euclidean",fontsize_row=4,cluster_cols=T,cluster_rows=F,fontsize_col  = 4,na_col = "grey",annotation_col = annoR)
```
