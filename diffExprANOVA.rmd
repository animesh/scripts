...
summary(dataNAR)
svgPHC<-pheatmap::pheatmap(data,clustering_distance_rows = "euclidean",clustering_distance_cols = "euclidean",fontsize_row=8,cluster_cols=F,cluster_rows=F,fontsize_col  = 8,na_col = "grey")
