...
par(mfrow=c(1,2))
#library/packages
inpD<-"F:/promec/Qexactive/Mirta/CLN3/combined/txt/"
hdr<-gsub("[^[:alnum:] ]", "",inpD)
...
svgPHC<-pheatmap::pheatmap(log2LFQimpCorr,clustering_distance_rows = "euclidean",clustering_distance_cols = "euclidean",fontsize_row=4,cluster_cols=T,cluster_rows=T,fontsize_col  = 4,labels_col = paste(label$Sample.Number,label$Sample_Name__),labels_row = label$Cell.Type_Sample.Group)
...
```{r label}
inpL<-paste0(inpD,"20210205_SampleKey-To Animesh.txt")
