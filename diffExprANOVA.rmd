...
sum(AQ3>0)
NC154<-apply(hda,1,function(x) if(sum(is.na(x[c(7:9)]))<3){median(x[c(7:9)],na.rm=T)} else{0})
sum(NC154>0)
NC163<-apply(hda,1,function(x) if(sum(is.na(x[13:15]))<3){median(x[13:15],na.rm=T)} else{0})
sum(NC163>0)
NC164<-apply(hda,1,function(x) if(sum(is.na(x[16:18]))<3){median(x[16:18],na.rm=T)} else{0})
sum(NC164>0)
...
plasma<-as.matrix(log2LFQ[,grep("plasma",colnames(log2LFQ))])
hist(as.matrix(plasma))
plasmaM<-apply(plasma,1,function(x) if(sum(is.na(x[1:3]))<3){median(x[1:3],na.rm=T)} else{0})
plasmaM<-apply(plasma,1,function(x) if(sum(is.na(x[1:2]))<2){median(x[1:2],na.rm=T)} else{0})
sum(plasmaM>0)
hdaM=cbind(NC154,NC163,NC164,plasmaM)
